"""
Django settings for testravinder_285 project.
...
ROOT_URLCONF = 'testravinder_285.urls'
...
WSGI_APPLICATION = 'testravinder_285.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testravinder_285 API",
    "DESCRIPTION": "API documentation for testravinder_285 App",
    "VERSION": "v1",
}
